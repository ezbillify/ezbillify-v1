// src/components/accounting/reports/sales/ProductWiseSales.js
'use client';
...
const ProductWiseSalesReport = ({ companyId }) => {
  ...
  const handleExport = async (format) => {
    ...
    try {
      ...
      switch (format) {
        case 'excel':
          await exportToExcel(exportData, 'product-wise-sales-report');
          success('Report exported to Excel successfully');
          break;
        case 'pdf':
          await exportToPDF(exportData, 'product-wise-sales-report');
          success('Report exported to PDF successfully');
          break;
        case 'json':
          await exportToJSON(exportData, 'product-wise-sales-report');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Product-wise Sales Report</h1>
