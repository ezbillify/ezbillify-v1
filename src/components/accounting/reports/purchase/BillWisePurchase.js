// src/components/accounting/reports/purchase/BillWisePurchase.js
'use client';
...
const BillWisePurchaseReport = ({ companyId }) => {
  ...
  const handleExport = async (format) => {
    ...
    try {
      ...
      switch (format) {
        case 'excel':
          await exportToExcel(exportData, 'bill-wise-purchase-report');
          success('Report exported to Excel successfully');
          break;
        case 'pdf':
          await exportToPDF(exportData, 'bill-wise-purchase-report');
          success('Report exported to PDF successfully');
          break;
        case 'json':
          await exportToJSON(exportData, 'bill-wise-purchase-report');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Bill-wise Purchase Report</h1>
