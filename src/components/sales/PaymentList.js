  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Customer Payments</h1>
          <p className="text-slate-600 mt-1">Manage customer payments and allocations</p>
        </div>
        <Button
          variant="primary"
                ...
                <tr>
                  <td colSpan="8" className="px-6 py-12 text-center">
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Get started by receiving a new payment.
                    </p>
                    <div className="mt-6">
                      <Button
                        variant="primary"
                    ...
                    <td className="px-6 py-4">
                      ...
                      {payment.branch && (
                        <div className="text-xs text-slate-500 mt-1">
                          {payment.branch.name || payment.branch.branch_name}
                        </div>
                      )}
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-slate-500">
                        Total: {formatCurrency(
                          payment.allocations?.reduce((sum, alloc) => sum + (alloc.allocated_amount || 0), 0) || 0
                        )}
                      </div>
                    </td>
        ...
        {payments.length > 0 && (
          <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between">
            <div className="text-sm text-slate-700">
              ...
              {Math.min(pagination.page * pagination.limit, totalItems)} of {totalItems} payments
            </div>
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to delete payment ${selectedPayment?.payment_number}? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
        loading={loading}
